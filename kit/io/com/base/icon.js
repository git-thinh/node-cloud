{
    mounted: function() {
        ...
        Vue.nextTick(function () {
            ...
            if (self.img_loading > 0) self._classAdd(self.$el, '__img_loading');
            if (self.updating) self._classAdd(self.$el, '__updating');
            if (self.text && self.text.length > 0) self._classAdd(self.$el, '__text');

            if (self.vpClass && self.vpClass.length > 0) self._classAdd(self.$el, self.vpClass);
        });
    },
    methods: {
